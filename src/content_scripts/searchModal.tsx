...
function SearchModal() {
  ...
  const handleClick = () => {
    chrome.runtime.sendMessage(
      { poiId: poiId, poiName: poiName, searchNumber: searchNumber },
      function (response) {
  ...
  return (
    <div>
      <div className="inputContainer">
        ...
        <input
          id={POI_ID}
          placeholder="输入 poi id"
          type="text"
          onChange={(event) => handleChange(event, POI_ID)}
        />
      </div>
      <div className="inputContainer">
        ...
        <input
          id={POI_NAME}
          placeholder="输入 poi name"
          type="text"
          onChange={(event) => handleChange(event, POI_NAME)}
        />
      </div>
      <div className="inputContainer">
        ...
        <input
          id={SEARCH_NUMBER}
          placeholder="输入 想要搜索的数量"
          type="text"
          onChange={(event) => handleChange(event, SEARCH_NUMBER)}
        />
      </div>
