chrome.storage.local.set({searchParams: {poiId: "", poiName: "", searchNumber: ""}});
...
chrome.runtime.onMessage.addListener(
  function(request, sender, sendResponse) {
    ...
    if (poiId !== "" && poiName !== "" && searchNumber !== "") {
      chrome.storage.local.set({searchParams: {poiId: poiId, poiName: poiName, searchNumber: searchNumber}});
